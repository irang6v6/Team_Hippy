		...
		<article>
			<form:form method="post" modelAttribute="articleEdit">
				...
				<form:select path="locationId" class="form-control">
					...
					<br>
					<form:radiobuttons path="tagId" itemValue="id" class="form-control"
						itemLabel="tagName" items="${ tags }" />
					<br>
					<form:radiobuttons path="moodId" itemValue="id" class="form-control"
						itemLabel="mood" items="${ moods }" />
					<br>
					<form:radiobuttons path="partyId" itemValue="id" class="form-control"
